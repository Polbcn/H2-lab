...
<Library LVVersion="24008000">
	...
	<Item Name="ConnectSalicruAPI (SubVI).vi" Type="VI" URL="../SALICRU API/ConnectSalicruAPI (SubVI).vi"/>
	<Item Name="ReadSalicruAPI (SubVI).vi" Type="VI" URL="../SALICRU API/ReadSalicruAPI (SubVI).vi"/>
	<Item Name="SALICRUPythonFile(SubVI).vi" Type="VI" URL="../SALICRU API/SALICRUPythonFile(SubVI).vi"/>
</Library>
